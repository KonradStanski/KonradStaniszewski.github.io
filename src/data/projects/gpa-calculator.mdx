...
[LINK TO PROJECT](https://konradstaniszewski.com/projects/gpacalculator)

[LINK TO CODE](https://github.com/KonradStanski/KonradStaniszewski.github.io/tree/master/src/pages/projects/gpacalculator)
...
example is built with [Next.js and React](https://konradstaniszewski.com/blog/blog-redesign-2). So as a small pet
...
Using React, I built out the form for providing the copied text, and simply validated it using some regex. I used regex
to identify where semesters start and end, and then extracted individual class information from these. These then get
processed to determine GPA, and all of this is then passed to chart.js where I plot your results.
...
utility in trying to go over each one and add a dropdown to let you choose which one you are, and calculate your
graduating GPA accordingly, but this would probably be a lot of work. I might get around to it someday.

One other thing I would like to provide would be the option of uploading the generated PDF transcript instead of
copy-pasting the text contents of the page. I plan on doing this once I get a free minute from schoolwork.
