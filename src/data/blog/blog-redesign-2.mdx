...
<NextImage
    ...
    src={`/images/blog/blog-redesign-2/lighthouse.png`}
/>
...
and embed codepens in my posts (as can be seen in my [Hamburger Menu tutorial](https://konradstaniszewski.com/blog/tailwind-hamburger)), 
